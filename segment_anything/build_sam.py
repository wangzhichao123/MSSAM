...
def _build_sam(
    ...
    sam = Sam(
        image_encoder=ImageEncoderViT(
            ...
            img_size=image_size,
            mlp_ratio=4,
            norm_layer=partial(torch.nn.LayerNorm, eps=1e-6),  # add initialization parameters.
...
def load_from(sam, state_dict, image_size, vit_patch_size):
    ...
    if pos_embed.shape[2] != token_size:       # 修正尺寸判断
        ...
        for k in global_rel_pos_keys:
            ...
            new_state_dict[k] = rel_pos_params[0, 0, ...]  # 降维
